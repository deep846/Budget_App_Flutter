...
class BudgetRepository{
  ...
  BudgetRepository({http.Client? client}) : _client = client = client ?? http.Client();
  void dispose(){
    _client.close();
  }
      ...
      if(response.statusCode==200)
        {
          ...
          return (data['results'] as List).map((e)=> Item.fromMap(e)).toList()..sort((a,b)=>b.date.compareTo(a.date));
        }
      else
        {
